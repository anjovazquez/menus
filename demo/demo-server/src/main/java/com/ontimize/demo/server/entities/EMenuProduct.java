...
public class EMenuProduct extends TableEntity {

	public EMenuProduct(EntityReferenceLocator locator, DatabaseConnectionManager dbConnectionManager, int port)
			throws Exception {
