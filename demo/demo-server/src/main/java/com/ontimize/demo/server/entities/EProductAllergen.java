...
public class EProductAllergen extends TableEntity {

	public EProductAllergen(EntityReferenceLocator locator, DatabaseConnectionManager dbConnectionManager, int port)
			throws Exception {
