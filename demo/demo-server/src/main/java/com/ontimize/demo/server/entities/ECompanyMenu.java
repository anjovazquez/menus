...
public class ECompanyMenu extends TableEntity {

	public ECompanyMenu(EntityReferenceLocator locator, DatabaseConnectionManager dbConnectionManager, int port)
			throws Exception {
